...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220302032700_PrimeiraMigracao')
BEGIN
...
BEGIN
    ...
    VALUES (N'20220302032700_PrimeiraMigracao', N'6.0.2');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20220302044323_AdicionarEmailAEntidadeCliente')
BEGIN
    ALTER TABLE [Clientes] ADD [Email] nvarchar(max) NOT NULL DEFAULT N'';
END;
GO
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20220302044323_AdicionarEmailAEntidadeCliente', N'6.0.2');
END;
GO
